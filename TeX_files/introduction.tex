...
improving accessibility for those who have disabilities.

The Internet of Things is built on {\em The Semantic Web}, a body of open standards that allows these devices to ``speak the same language'' to one another.
