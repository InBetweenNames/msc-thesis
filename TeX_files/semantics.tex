...
%TODO: define filter_ev here instead of in transitive verbs
Both these problems were solved by defining \texttt{filter\_ev} in our
...
Informally, \texttt{filter\_ev} collects all of the relevant properties for
each preposition from all events, and evaluates the termphrase over the
FDBRs.  It then computes the intersection of those
...
\texttt{filter\_ev} is used as a predicate for filtering FDBRs and is defined as follows:
