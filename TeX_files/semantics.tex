...
preposition on each corresponding FDBR, solving the first problem.  The second
problem is solved by using the intersections of all events in all FDBRs as a way
