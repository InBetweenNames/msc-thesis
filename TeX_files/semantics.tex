...
Our demonstration program, Solarman, uses an event-based denotational semantics in order to perform queries on the Semantic Web.  In this Chapter we present
...
The semantics in this Thesis is based on work that was originally described by Frost et al. in 2013\cite{frost2013event}.  That work was later improved upon by Frost and Agboola in 2014\cite{frostagboola2014}.
