...
\subsection{Multiple-property prepositions}

Prepositions were previously defined as a pair consisting of the name of a property of an event and a termphrase.  We modify this definition
to use a list of property names instead of a single name in order to support prepositions such as ``in'', which may refer to either a location or a point in time.

\begin{definition}[Preposition]
	A pair consisting of a list of property names and a predicate.
\end{definition}
