...
\begin{center}
	{\em This Thesis is dedicated to my meme and pepe, Theresa and Fred Bombardier}
\end{center}
...
\begin{uwindefaultspaceenv}
	...
	My External and Internal Readers, Dr. Richard J. Caron and Dr. Luis G. Rueda, for being available on short notice to participate on my Thesis Committee.
	
	David MacMillan, Bryan St. Amour and Paul Preney, for being great lab partners, being up for interesting conversations, and always lending an ear when needed.
	Thank you also Bryan and Paul for letting me use your LaTeX styles and giving my first draft a read.
	
	All of the secretaries in the School of Computer Science for their help during my degree, whether it was getting me through scheduling nightmares or helping me get things done by the deadlines.
	
	And my friend Kyle Iaquinta for taking the time to proofread my Thesis and generally providing me with positive encouragement throughout my degree.
